---
slug: animating-gridviewitems-with-windows-ui-composition-aka-the-visual-layer
date: 2018-07-21
...
![Example of animation in myTube Beta: video thumbnails pop out on hovering over them](01-mytube.gif "In myTube Beta, the thumbnail pops out of the item, which creates a lovely experience")
...
![The final result: GridViewItems scale up and show a shadow when the mouse hovers over them](02-finalresult.gif "The GridViewItems scale up and show a shadow when the mouse hovers over them")
...
![A diagram showing the position of the Visual layer between the Framework layer (XAML) and the Graphics layer (DirectX)](03-visual-layer-diagram.png "The Visual layer sits between the Framework layer (XAML) and the Graphics layer (DirectX) - Source: Microsoft")
...
![The rectangles now scale up when the mouse hovers over them](04-firstresult.gif "The rectangle is now animated, but it is not the lovely experience we are shooting for")
...
![The rectangles scale up from the center and the hover and reveal borders are removed](05-betterresult.gif "That looks much better")
...
![The rectangles now have static shadows that scale with the rectangle](06-staticshadows.gif "Animated rectangles with static shadows")
...
![The shadow now only appears when the rectangle is scaled up](02-finalresult.gif "The shadow is now hidden by default and animates with the scale")
...
![The image in the ListItem pops out when it is dragged to the side](07-slidablelistitem.gif "The animation combines nicely with a SlidableListItem")

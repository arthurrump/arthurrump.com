---
slug: fallback-styling-for-embedded-tweets
date: 2019-04-27
...
![Two embedded tweets formatted with standard blockquote styling](blockquotes.png "Tweets styled like quotes with my old website theme")
...
![Comparison between my custom styling of the blockquote and Twitter's widget, with a Tweet by Scott Hanselman](fallback-shanselman.png "My custom blockquote styling on the left, the Twitter widget on the right")

![Another comparison, this time by Immo Landwerth](fallback-terrajobst.png "My custom blockquote styling on the left, the Twitter widget on the right")

...
<p style="font-size: .9em">Vakoverstijgende module voor filosofie en informatica</p>

<p style="margin-top: 1.4em">
Karen van Wichen en Arthur Rump<br>
<span style="font-size: .9em">Q-vakken (van Quadraam)</span>
</p>

<p style="font-size: .7em; margin-top: 1.4em">
Het Lerarencongres 2026<br>
5 oktober 2026
</p>

---

<div style="display: grid; grid-template-columns: 400px 400px; justify-items: center; justify-content: space-around">

<img style="border-radius: 25px" alt="Foto van Karen" src="assets/karen.png">

<img style="border-radius: 25px" alt="Foto van Arthur" src="assets/arthur.jpg">
...
<img height="120px" style="position: absolute; top: 0; right: 0; margin: 0" alt="Logo Q-vakken" src="assets/QUA_LOGOS_PROGRAMMA_plain.svg">

<div style="font-weight: bold; font-size: 1.6em;" class="row accent">
...
<span style="font-size: 1.4em">praktisch:</span>
<div class="row" style="font-weight: bold; font-size: 1.6em;">
...
<img alt="Foto van een donkere berg omgeven door mist. Op de berg staan de termen 'AI doom', 'deepfakes', 'surveillance', 'bitcoin', 'social media' en 'enshittification' geschreven" src="assets/massimiliano-morosinotto-3i5PHVp1Fkw-unsplash.svg" class="fragment custom doom-mountain" data-fragment-index="1">

<img alt="Persoon in een oranje jas op hun hurken bovenop een berg, die uitkijkt op andere bergtoppen" src="assets/marek-piwnicki-Foj3x1-MRv0-unsplash.jpg" class="fragment fade-left" data-fragment-index="1" style="width: 1020px; position: absolute; right: -40px;">
...
<img src="assets/werkblad_landscape.svg">
...
<img class="fragment" src="assets/ai11.png">

<img class="fragment" src="assets/ai12.png">

<img class="fragment" src="assets/ai13.png">
...
### Wenselijk scenario<br>en advies
...
<div class="accent" style="display: flex; justify-content: space-around; font-weight: bold;">
...
## Filosofie<br>van de<br>Technologie

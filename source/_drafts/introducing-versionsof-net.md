...
.NET Core versioning is a mess. There are lots and lots and lots of verion numbers, from runtime to SDK, from Visual Studio to languages and of course .NET Standard. So what SDK corresponds to which runtime again? I know there some sort of a system, but it differs per release. Here's my solution:

{% asset_img screenshot.png "Bringing clarity to versions of .NET" %}
...
These points are also in the [GitHub Issues](https://github.com/arthurrump/versionsof.net/issues), which is also the place to add your own suggestions. And don't forget to bookmark [versionsof.net](https://versionsof.net)!
